...
- [documentation/model_output_docs/SINGLE_CALL_TURN_EXTRACTOR_DESIGN.md](documentation/model_output_docs/SINGLE_CALL_TURN_EXTRACTOR_DESIGN.md): Canonical one-call extractor contract and JSON schema for movement + scene + knowledge updates.
