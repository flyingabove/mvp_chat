# backend/app/evaluation/fakes.py
...
from backend.app.evaluation.targets import ArmSession, TurnResult
...
def make_arm(side: str, replies: list[str], *, pair_id: str = "p", players: list[str] | None = None,
    ...
    from backend.app.evaluation.contracts import ArmStatus, ArmTranscript, TurnRecord
...
def tiny_bundle():
    ...
    from backend.app.evaluation.knowledge import build_bundle
