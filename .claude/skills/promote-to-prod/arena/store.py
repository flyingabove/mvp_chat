...
from arena.contracts import ArmTranscript, ExperimentManifest


def default_root() -> Path:
    """Local artifacts only: the arena never runs inside a deployment."""
    from arena.paths import ARTIFACT_ROOT
